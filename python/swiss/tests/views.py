...
class Tests(TestCase):
    ...
    def test_start_new_round_for_family(self):
        ...
        views.add_player(league_id=dict_league['id'], data={'name': '6', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '7', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '8', 'memo': ''})
    ...
    def test_start_new_round_for_ghost(self):
        ...
        views.add_player(league_id=dict_league['id'], data={'name': '1', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '2', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '3', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '4', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '5', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '6', 'memo': ''})
        views.add_player(league_id=dict_league['id'], data={'name': '7', 'memo': ''})
